...
def parseconfs(dirName):
    ...
    for fileName in configList:
        ...
        if os.path.exists(absFileName):
            ...
            #qiepianColsStr =  "etl_dt" + " " + "STRING," + colsStr
            qiepianColsStr =   colsStr


            dic["columns"] = colsStr
            dic["qiepianCols"] = qiepianColsStr
            dic["hischainCols"] = hischainColsStr
...
def createTables(dic):
    ...
    print "hive_table name:"  + tablename
    alltableName = tablename + "_all"
    #flag = dropOneTable(alltableName)


    hischainTable = tablename + "_his"
    hischainFields = dic["hischainCols"]
    #flag = createOneTable(hischainTable,hischainFields,"e_dt")

    
    qiepianTable = dbname +  "." + tablename 
    qiepianFields  = dic["qiepianCols"]
    flag = createOneTable(qiepianTable,qiepianFields,"etl_dt")
